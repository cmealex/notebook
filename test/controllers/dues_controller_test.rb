...
class DuesControllerTest < ActionController::TestCase
  ...
  test "should create due" do
    assert_difference('Due.count') do
      post :create, due: { date: @due.date, dueType: @due.dueType, sum: @due.sum, userId: @due.userId }
    end
  ...
  test "should update due" do
    patch :update, id: @due, due: { date: @due.date, dueType: @due.dueType, sum: @due.sum, userId: @due.userId }
    assert_redirected_to due_path(assigns(:due))
  end
